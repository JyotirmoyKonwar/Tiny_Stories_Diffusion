...
weights_path = "tinystories_diffusion_med_dual.pt"
...
with gr.Blocks(theme=gr.themes.Monochrome()) as demo:
    gr.Markdown("# TinyStories Diffusion LM (Medium Dual)")
    gr.Markdown("A non-autoregressive language model leveraging parallel block-decoding and SwiGLU networks. Medium Dual Model.")
